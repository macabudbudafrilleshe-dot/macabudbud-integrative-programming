...
I became more familiar with HTML and CSS. The most challenging part was experimenting with colors, font sizes, fonts, and overall design choices to find what worked best.

---

## Pages Added

- login.html – Login user interface page
- signup.html – Signup user interface page
